...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        public void TestThatUserDoesRemoveFlightFromServiceLocatorWhenBooked()
        {
            ...
            var flightToBook = new Flight(new DateTime(2009, 11, 1), new DateTime(2010, 11, 1), 10);
            var remainingFlight = new Flight(new DateTime(2009, 11, 1), new DateTime(2010, 1, 1), 20);
